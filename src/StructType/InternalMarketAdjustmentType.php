...
/**
 * This class stands for InternalMarketAdjustmentType StructType
 * @subpackage Structs
 */
class InternalMarketAdjustmentType extends AbstractStructBase
{
    /**
     * The Factor
    ...
    public $Valuation;
    /**
     * Constructor method for InternalMarketAdjustmentType
     * @uses InternalMarketAdjustmentType::setFactor()
     * @uses InternalMarketAdjustmentType::setValuation()
     ...
     * Set Factor value
     * @param integer $factor
     * @return \Autovista\Valuation\StructType\InternalMarketAdjustmentType
     */
