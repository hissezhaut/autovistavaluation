...
/**
 * This class stands for DirectImportAdjustmentType StructType
 * @subpackage Structs
 */
class DirectImportAdjustmentType extends AbstractStructBase
{
    /**
     * The Factor
    ...
    public $Valuation;
    /**
     * Constructor method for DirectImportAdjustmentType
     * @uses DirectImportAdjustmentType::setFactor()
     * @uses DirectImportAdjustmentType::setValuation()
     ...
     * Set Factor value
     * @param integer $factor
     * @return \Autovista\Valuation\StructType\DirectImportAdjustmentType
     */
