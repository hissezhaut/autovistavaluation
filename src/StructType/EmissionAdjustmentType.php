...
/**
 * This class stands for EmissionAdjustmentType StructType
 * Meta informations extracted from the WSDL
 * - documentation: Adjustment factor related to emission.
 * @subpackage Structs
 */
class EmissionAdjustmentType extends AbstractStructBase
{
    /**
     * The Amount
     * @var double
    ...
    public $Valuation;
    /**
     * Constructor method for EmissionAdjustmentType
     * @uses EmissionAdjustmentType::setAmount()
     * @uses EmissionAdjustmentType::setValuation()
     * @param double $amount
     ...
     * Set Amount value
     * @param double $amount
     * @return \Autovista\Valuation\StructType\EmissionAdjustmentType
     */
