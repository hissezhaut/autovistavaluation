...
/**
 * This class stands for InspectionAdjustmentType StructType
 * @subpackage Structs
 */
class InspectionAdjustmentType extends AbstractStructBase
{
    /**
     * The Amount
     * @var double
    ...
    public $Valuation;
    /**
     * Constructor method for InspectionAdjustmentType
     * @uses InspectionAdjustmentType::setAmount()
     * @uses InspectionAdjustmentType::setValuation()
     * @param double $amount
     ...
     * Set Amount value
     * @param double $amount
     * @return \Autovista\Valuation\StructType\InspectionAdjustmentType
     */
