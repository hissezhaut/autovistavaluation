...
/**
 * This class stands for ServiceHistoryAdjustmentType StructType
 * @subpackage Structs
 */
class ServiceHistoryAdjustmentType extends AbstractStructBase
{
    /**
     * The Factor
     * @var int
    ...
    public $Valuation;
    /**
     * Constructor method for ServiceHistoryAdjustmentType
     * @uses ServiceHistoryAdjustmentType::setFactor()
     * @uses ServiceHistoryAdjustmentType::setAmount()
     * @uses ServiceHistoryAdjustmentType::setValuation()
     * @param int $factor
     * @param double $amount
     ...
     * Set Factor value
     * @param int $factor
     * @return \Autovista\Valuation\StructType\ServiceHistoryAdjustmentType
     */
