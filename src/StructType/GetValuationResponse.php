...
/**
 * This class stands for GetValuationResponse StructType
 * @subpackage Structs
 */
class GetValuationResponse extends AbstractStructBase
{
    /**
     * The Settings
    ...
    public $Valuation;
    /**
     * Constructor method for GetValuationResponse
     * @uses GetValuationResponse::setSettings()
     * @uses GetValuationResponse::setValuation()
     ...
     * Set Settings value
     * @param \Autovista\Valuation\StructType\ETGsettingType $settings
     * @return \Autovista\Valuation\StructType\GetValuationResponse
     */
