...
/**
 * This class stands for DamageAdjustmentType StructType
 * @subpackage Structs
 */
class DamageAdjustmentType extends AbstractStructBase
{
    /**
     * The Factor
    ...
    public $Valuation;
    /**
     * Constructor method for DamageAdjustmentType
     * @uses DamageAdjustmentType::setFactor()
     * @uses DamageAdjustmentType::setAmount()
     * @uses DamageAdjustmentType::setValuation()
     * @param int $factor
     * @param double $amount
     ...
     * Set Factor value
     * @param int $factor
     * @return \Autovista\Valuation\StructType\DamageAdjustmentType
     */
